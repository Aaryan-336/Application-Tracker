                ...
                {!statusData.is_connected ? (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="console-panel p-6 rounded space-y-4 border border-dashed border-border/80">
                            ...
                            <ol className="list-decimal pl-4 space-y-3 font-mono text-[11px] text-gray-400 leading-relaxed">
                                <li>Open your <a href="https://myaccount.google.com/" target="_blank" rel="noreferrer" className="text-accent underline">Google Account settings</a>.</li>
                                <li>Search or navigate to **Security** and enable **2-Step Verification**.</li>
                                <li>In Security, select **App passwords** (you might need to log in again).</li>
                                <li>Provide a custom name like "Applications Tracker" and click **Create**.</li>
                                <li>Copy the generated 16-character code (exclude spaces) and paste it into the password field.</li>
                            </ol>
                        </div>
                    </div>
                ) : (
                    <div className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="console-panel p-5 rounded space-y-2 col-span-2">
                                <span className="text-[10px] text-gray-500 font-mono block uppercase">CONNECTED_STREAM_TARGET</span>
                                <h3 className="font-bold text-white text-base font-mono">{statusData.gmail_address}</h3>
